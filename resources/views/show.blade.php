      ...
      <svg viewBox="0 0 20 20" fill="currentColor" class="chevron-right w-6 h-6">
        <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
            ...
            <div class="md:flex lg:justify-between space-y-3 items-center my-3 lg:pr-3">
                ...
                <div>
                    <button class="bg-green-500 hover:bg-green-700 text-white md:px-9 py-2 rounded-xl flex items-center justify-center space-x-2 w-full md:w-auto" onclick="window.open(`\/\/api.whatsapp.com\/?phone={{ $toko_whatsapp }}?text=${encodeURIComponent('{{ url()->current() }}   \r\n Hai Admin, saya ingin tau tentang product ini. boleh di bantu?')}`)">
