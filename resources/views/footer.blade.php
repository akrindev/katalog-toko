    ...
    <div class="bg-black">
        <footer class="flex items-center p-3">
            <div class="container mx-auto flex flex-col items-center">
                ...
                <ul class="block md:flex items-center mx-auto text-white text-center space-x-3">
                    <li class="cursor-pointer hover:underline">Perjanjian Pengguna</li>
                    <li class="cursor-pointer hover:underline">Kebijakan Privasi</li>
                    <li class="cursor-pointer hover:underline">Contact Us</li>
                </ul>

                <div class="flex mx-auto text-white text-center">
                    Copyright Dian Busana © 2021
                </div>
            </div>
        </footer>
    </div>
